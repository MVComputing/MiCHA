...
public class Test_Example {
     ...
     */
    @Test
    @Story(TestDescription.DESC_EXAMPLE_HU_01)
    @Description(TestDescription.DESC_EXAMPLE_FLUJO_1)
    @Severity(SeverityLevel.NORMAL)
    @Owner(Data.DATA_OWNER_MV)
    @Link(name = "Sitio web de pruebas QA", url = "")
    public void flujo1() throws IOException {
        Log.info(LogInfo.LOG_SEPARATE);
        Log.info(LogInfo.LOG_TEST_START + TestDescription.DESC_EXAMPLE_TEST_NAME_F1);
        Base.date = page.getDate(Data.DATA_FECHA_DDMMYYYY);
        testName.set(TestDescription.DESC_EXAMPLE_TEST_NAME_F1);
